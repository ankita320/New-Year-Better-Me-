...
function updateGameArea() {
    ...
    if (myGameArea.frameNo == 1 || everyinterval(150)) {
        ...
        myObstacles.push(new component(10, x - height - gap, "salmon", x, height + gap));
    }
    for (i = 0; i < myObstacles.length; i += 1) {
        myObstacles[i].x += -1;
...
<br>
<button id= "acc" onmousedown="accelerate(-0.2)" onmouseup="accelerate(0.05)" class="acc">A C C E L E R A T E</button>
